      ...
      <div class="x_content">
        <div class="form-group">
          ...
          <div class="col-md-9 col-ksm-9 col-xs-12">
            <input type="text" class="form-control" name="cedulaPadre" placeholder="Cedula" value="{{ $representante->cedula or old('cedulaPadre') }}" {{ $disabled }}>
        ...
        <div class="form-group">
          ...
          <div class="col-md-9 col-sm-9 col-xs-12">
            <input type="text" name="nombrePadre" class="form-control" placeholder="Primer nombre" value="{{ $representante->nombre or old('nombrePadre') }}" {{ $disabled }}>
        ...
        <div class="form-group">
          ...
          <div class="col-md-9 col-sm-9 col-xs-12">
            <input type="text" name="nombre2Padre" class="form-control" placeholder="Segundo nombre" value="{{ $representante->nombre2 or old('nombre2Padre') }}" {{ $disabled }}>
        ...
        <div class="form-group">
          ...
          <div class="col-md-9 col-ksm-9 col-xs-12">
            <input type="text" class="form-control" name="apellidoPadre" placeholder="Primer apellido" value="{{ $representante->apellido or old('apellidoPadre') }}" {{ $disabled }}>
        ...
        <div class="form-group">
          ...
          <div class="col-md-9 col-ksm-9 col-xs-12">
            <input type="text" class="form-control" name="apellido2Padre" placeholder="Segundo apellido" value="{{ $representante->apellido2 or old('apellido2Padre') }}" {{ $disabled }}>
        ...
        <div class="form-group">
          ...
          <div class="col-md-9 col-ksm-9 col-xs-12">
            <input type="text" class="form-control" name="fechaNacimientoPadre" placeholder="dd/mm/yyyy" value="{{ $representante->fecha_nacimiento or old('fechaNacimientoPadre') }}" {{ $disabled }}>
        ...
        <div class="form-group">
          ...
          <div class="col-md-9 col-ksm-9 col-xs-12">
            <input type="text" class="form-control" name="ocupacionPadre" placeholder="Ocupación" value="{{ $representante->ocupacion or old('ocupacionPadre') }}" {{ $disabled }}>
        ...
        <div class="form-group">
          ...
          <div class="col-md-9 col-ksm-9 col-xs-12">
            <input type="text" class="form-control" name="direccionTrabajoPadre" placeholder="Direccion del trabajo" value="{{ $representante->direccion_trabajo or old('direccionTrabajoPadre') }}" {{ $disabled }}>
        ...
        <div class="form-group">
          ...
          <div class="col-md-9 col-ksm-9 col-xs-12">
            <input type="text" class="form-control" name="telefonoPadre" placeholder="Teléfono" value="{{ $representante->telefono or old('telefonoPadre') }}" {{ $disabled }}>
        ...
        <div class="form-group">
          ...
          <div class="col-md-9 col-ksm-9 col-xs-12">
            <input type="text" class="form-control" name="telefono2Padre" placeholder="Otro teléfono" value="{{ $representante->telefono2 or old('telefono2Padre') }}" {{ $disabled }}>
            @if ($errors->has('nombre2Padre'))
